...
namespace LightSide
{
    ...
    public abstract partial class UniTextBase
    {
        ...
        /// <summary>Raised before any text processing in the current canvas update cycle.</summary>
        public static event Action BeforeProcess;
        /// <summary>Raised after meshes are applied to renderers, before canvas rendering begins.</summary>
        public static event Action MeshApplied;
        /// <summary>Raised after all text processing is complete, after <see cref="MeshApplied"/>.</summary>
        ...
        {
            Cat.MeowFormat("[UniText] DoGenerateMeshData entry: name={0}, tpHash={1}, hasFirstPass={2}, hasPositions={3}",
            ...
            Cat.MeowFormat("[UniText] After EnsurePositions: name={0}, tpHash={1}, glyphCount={2}, hasValid={3}",
