...
namespace LightSide
{
    ...
    internal sealed class SceneVisibilityOverlay : IMGUIOverlay, ITransientOverlay
    {
        ...
        internal const string ShowOverlayMenuPath = "Tools/UniText/Show Scene Visibility Overlay";
        ...
        public static bool Show
        {
            ...
            set
            {
                ...
                Menu.SetChecked(ShowOverlayMenuPath, value);
        ...
        private static void SyncMenuOnLoad()
        {
            EditorApplication.delayCall += () =>
            {
                ...
                Menu.SetChecked(ShowOverlayMenuPath, Show);
            };
        }
        ...
        [MenuItem(ShowOverlayMenuPath, false, 201)]
        private static void ToggleShowOverlayMenu() => Show = !Show;

        [MenuItem(ShowOverlayMenuPath, true)]
