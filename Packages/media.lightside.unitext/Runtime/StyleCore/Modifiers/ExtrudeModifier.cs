...
namespace LightSide
{
    ...
    public class ExtrudeModifier : EffectModifier
    {
        ...
        [SerializeField] private bool bevel;
        ...
        /// </summary>
        /// <remarks>
        /// Changing this re-allocates the layer ring buffers and requeues a mesh rebuild
        /// (<see cref="UniTextDirtyFlags.Color"/>). Parse / shape / layout caches are reused.
        /// </remarks>
        public int Steps
        {
            get => steps;
        ...
        /// <summary>
        /// When <see langword="true"/>, layers alternate between the near and far face colors
        ...
        /// <remarks>
        /// Changing this re-allocates the layer ring buffers and requeues a mesh rebuild
        /// (<see cref="UniTextDirtyFlags.Color"/>).
        /// </remarks>
        public bool Bevel
        {
            get => bevel;
