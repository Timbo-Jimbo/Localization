...
namespace LightSide
{
    ...
    public sealed class GradientModifier : BaseModifier
    {
        ...
        /// <summary>
        /// Source of named gradients used by this modifier when resolving <c>&lt;gradient=name&gt;</c>
        /// tags. <see langword="null"/> disables resolution and causes such tags to be skipped
        /// with a warning.
        /// </summary>
        /// <remarks>
        /// The provider is consulted in <c>OnApply</c> (text-attribute pass), so swapping it
        /// requeues a re-parse via <see cref="UniTextDirtyFlags.Text"/> — existing gradient
        /// definitions cached in the shared attribute data are discarded and rebuilt against
        /// the new provider.
        /// </remarks>
        public IGradientProvider Provider
        {
            ...
            set
            {
                ...
                if (IsInitialized && provider != null) provider.Changed -= OnGradientSourceChanged;
                provider = value;
                if (IsInitialized && provider != null) provider.Changed += OnGradientSourceChanged;
        ...
        protected override void OnEnable()
        {
            ...
            if (provider != null) provider.Changed += OnGradientSourceChanged;
        }
        ...
        protected override void OnApply(int start, int end, string parameter)
        {
            ...
            if (!provider.TryGet(gradientName, out var entry) || entry.gradient == null)
            {
