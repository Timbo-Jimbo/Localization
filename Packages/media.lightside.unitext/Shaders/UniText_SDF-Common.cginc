...
// ============================================
// Effect color unpack (matches C# EffectPacking.PackColor)
// ============================================
...
//
// Source semantics: Color32 bytes copied verbatim from C# (sRGB / gamma).
// Unlike vertex color, UV channels are not touched by the Canvas pipeline,
// so the gamma->linear conversion is unconditional in linear color space.

half4 UnpackEffectColor(float rg, float ba)
{
